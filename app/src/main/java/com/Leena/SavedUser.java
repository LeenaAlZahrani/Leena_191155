...
public class SavedUser {
    ...
    private MySQLiteHelper SQLitedb;
    private int id;
    ...
    public SavedUser(Context context){
        SQLitedb=new MySQLiteHelper(context);
    }


    public SavedUser(String firstName, String lastName,String phoneNumber,String emailAddress,Context context) {
    ...
    public void addFavoriteUser(SavedUser favoriteUser){
    ...
    public ArrayList<SavedUser> getAllfavoriteUsers(Context context) {
        ArrayList<SavedUser> favoriteUsers = new ArrayList<SavedUser>();

        String query = "SELECT  * FROM " + TABLE_User;
        SQLiteDatabase db = SQLitedb.getReadableDatabase();
        Cursor cursor = db.rawQuery(query, null);

        SavedUser favoriteUser = null;
        if (cursor.moveToFirst()) {
            do {
                favoriteUser = new SavedUser(context);
    ...
    public void deleteBook(SavedUser favoriteUser) {
    ...
    public int updateUser(SavedUser favoriteUser, int userId) {
