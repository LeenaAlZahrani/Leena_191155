...
Boolean stopGetData = false;
    ...
    public void addUserToFireBase(View view) {
       ...
       databaseReference = FirebaseDatabase.getInstance().getReference("users");
            ...
            Toast.makeText(addToFireBase.this, "Please Wait",
            ...
            databaseReference.addValueEventListener(new ValueEventListener() {
                ...
                public void onDataChange(DataSnapshot dataSnapshot) {
                    ...
                    if (stopGetData == false) {
                        ...
                        Toast.makeText(addToFireBase.this, "users added successfully",
                                Toast.LENGTH_LONG).show();
        ...
        {
            Toast.makeText(addToFireBase.this, "Please enter all data", Toast.LENGTH_LONG).show();
